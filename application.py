...
# Page configuration
st.set_page_config(
    page_title="[25RP19905]]Crop Recommendation System",
    page_icon="🌱",
    layout="centered"
)

st.title("🌱 Crop Recommendation System[25RP19905]")
...
try:
    model_path = os.path.join(BASE_DIR, "crop_model_25RP19905.pkl")  # your model file
    le_path = os.path.join(BASE_DIR, "label_encoder_25RP19905.pkl")         # your actual label encoder file
...
# Footer / info
st.markdown("---")
st.markdown("This app is based on CROP Recommendation Model FROM 25RP19905**.")
